...
// ══════════════════════════════════════════════════════
// ImageProcessor — stateless ROI + preprocessing
// ══════════════════════════════════════════════════════
class ImageProcessor {
public:
    // Accepts DetectionParams by const ref (runtime-tunable)
    explicit ImageProcessor(const DetectionParams& params);
...
private:
    ...
    mutable cv::cuda::GpuMat gpu_gray_, gpu_blurred_, gpu_thresh_;
